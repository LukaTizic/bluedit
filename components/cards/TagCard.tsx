...
const TagCard = ({
  ...
  return (
    <Link href={ROUTES.TAG(_id)} className="shadow-light100_darknone">
      <article className="dark:bg-dark-200 bg-light-900  light-border flex w-full flex-col rounded-2xl border px-8 py-10 sm:w-[260px] ">
        ...
        <p className="small-regular text-dark500-light700 mt-5 line-clamp-3 w-full">
          {iconDescription}
        </p>
